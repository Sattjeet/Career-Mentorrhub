  ...
  async function fetchAndRenderAnnouncements() {
    try {
      const response1 = await fetch(
        "http://localhost:3000/rss-career-counselling"
      );
      const data1 = await response1.json();
      const announcements = data1;
      console.log(data1);

      const response2 = await fetch("http://localhost:3000/rss-Education");
      const data2 = await response2.json();
      announcements.push(...data2);

      const response3 = await fetch("http://localhost:3000/rss-career-mentor");
      const data3 = await response3.json();
      announcements.push(...data3);
      ...
      announcements.forEach((announcement) => {
        ...
        span.textContent = announcement.pubDate;
        ...
        read_more_btn.href = announcement.link;
